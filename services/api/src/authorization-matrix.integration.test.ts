...
const PROTECTED_HTTP_MATRIX: HttpProbe[] = [
  ...
  {
    key: "POST /v1/device-links/challenges/:id/approve",
    method: "POST",
    url: `/v1/device-links/challenges/${RESOURCE_ID_CANARY}/approve`
  },
  {
    key: "POST /v1/device-links/challenges/:id/deny",
    method: "POST",
    url: `/v1/device-links/challenges/${RESOURCE_ID_CANARY}/deny`
  },
  {
    key: "POST /v1/device-links/challenges/:id/redeem",
    method: "POST",
    url: `/v1/device-links/challenges/${RESOURCE_ID_CANARY}/redeem`
  },
  {
  ...
  { key: "GET /v1/search/chats", method: "GET", url: `/v1/search/chats?q=${CONTENT_CANARY}` },
  {
